...
function AcademicProject() {
 ...
 <ScrollPage style={{}}>
        ...
        <ScrollPage style={{backgroundColor:""}} >
          <Animator animation={batch(Move(0,4800),StickyIn(), FadeIn(), ZoomIn())}style={{fontSize:40, margin:"auto"}}>
          <img src={process.env.PUBLIC_URL +"/images/team-skl/webImgTeam.png"} style={{width:700}} />
            <br/><br/>
            <div style={{color:"black"}}>동아리 구성원들이 함께 제작</div>
            <hr/>
            <div style={{fontSize:30}}>백엔드와 프론트엔드 팀으로 구성하여 참여
            <br></br>
            <button 
            className="titleBt"
            style={{marginTop:20,fontSize:20,width:150}}
              onClick={()=>{
  ...
  return (
    <>
        ...
        >
          ...
          <SwiperSlide>
          <img src={process.env.PUBLIC_URL + "/images/team-skl/webSlideImg2.png"} className="slideImg" />
          </SwiperSlide>
          <SwiperSlide>
          <img src={process.env.PUBLIC_URL + "/images/team-skl/webSlideImg3.png"} className="slideImg" />
          </SwiperSlide>
