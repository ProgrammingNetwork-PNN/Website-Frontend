...
function AcademicProject() {
 ...
 <ScrollPage style={{}}>
          <Animator >
            <div  style={{fontSize:40, paddingTop:40, paddingBottom:40}} className="test">
              2022 P&N 학술제
              <br/>
            </div>
            <FrameMain></FrameMain>
        ...
        <ScrollPage>
          <Animator animation={batch(Move(0,3800),StickyIn(), FadeIn(), ZoomIn())}
          ...
          <br/><span style={{fontSize:25}}>*실제 기기 착용시 보이는 화면</span>
          </Animator>
        </ScrollPage>
        <ScrollPage>
        
          <Animator animation={batch(Move(0,3600),StickyIn(), FadeIn(), ZoomIn())} style={{fontSize:40, margin:"auto"}}>
          <hr/>
        ...
        <ScrollPage>
          <Animator animation={batch(Move(0,2800),StickyIn(), FadeIn(), ZoomIn())}>
          <hr/>
          <img src={process.env.PUBLIC_URL + "/images/team-skl/academicImgVr.jpg"}  style={{width:500}} /><br/>
          <hr/>
          <span style={{fontSize:25}}>⚔동아리방에서 프로그램 체험 가능⚔</span>
          </Animator>
        </ScrollPage>
        
        <ScrollPage className="borderLay">
        
          <Animator animation={batch(Move(0,1000),Fade(), Sticky())} style={{fontSize:40}}>
          <hr/>
